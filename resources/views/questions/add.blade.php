...
//"#qs_type_" + qs_index
        $("body").on('change', 'select[id^="qs_type"]', function () {
            ...
            var text_ans =
                    ...
                    "</div>";
            var mcq_single =
                    "<div class='form-group' id='qs_choices_single_" + qs_index + '_' + signle_choice_index + "'>" +
                    "<label class='col-md-4 control-label'>Choice" + signle_choice_index + "</label>" +
                    "<div class='col-md-4'>" +
                    "<div class='radio'>" +
                    "<label for='qs_choice_single_" + qs_index + '_' + signle_choice_index + "'>" +
